...
//		private Keybinds? keybindSuperactions;

//		public XmlParser(ILogger<XmlParser> logger, IPathProvider pathProvider)
//		{
//			this.logger = logger;
...
//			if (keybindSuperactions is null)
//			{
//				keybindSuperactions = new Keybinds();
//			}

//			var defaultProfileXml = reader.ReadFile(Resources.DefaultProfileXML);
//			if (string.IsNullOrEmpty(defaultProfileXml))
//			{
//				return;
//			}
//			var profileSerializer = new XmlSerializer(typeof(Profile));
//			using var profileStringReader = new StringReader(defaultProfileXml);

//			defaultProfile = (Profile)profileSerializer.Deserialize(profileStringReader)!;
...
//			var keybindSerializer = new XmlSerializer(typeof(Keybinds));
//			using var keybindStringReader = new StringReader(defaultProfileXml);

//			Keybinds keybinds = (Keybinds)keybindSerializer.Deserialize(keybindStringReader)!;
//		}

//		private void ParseDefaultProfile(string xmlContent, Keybinds target)
//		{
//			try
//			{
...
//		private void ParseSuperactions(string xmlContent, Keybinds target)
//		{
//			var doc = XDocument.Parse(xmlContent);
